...
@Injectable()
export class PartnershipRequestsQueryService {
  private tableName = 'partnershipRequests';
  ...
  async getById(id: number): Promise<PartnershipRequests> {
  ...
  async getByIds(ids: number[]): Promise<PartnershipRequests[]> {
